static class GameMaster
{
    ...
    public static string Describe(TravelMethod travelMethod) => $"You're traveling to your destination {(travelMethod == TravelMethod.Walking ? "by" : "on")} {travelMethod.ToString().ToLower()}.";
